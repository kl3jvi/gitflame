...
enum class EventType(val event: Int, val icon: Int) {
    ...
    CommitCommentEvent(R.string.commented_on_commit, R.drawable.ic_comment),//has coment
    DownloadEvent(R.string.starred, R.drawable.ic_star_filled),
    ...
    IssueCommentEvent(R.string.commented_on_issue, R.drawable.ic_comment),//has coment
    ...
    PullRequestReviewCommentEvent(R.string.pr_comment_review, R.drawable.ic_comment), //has coment
